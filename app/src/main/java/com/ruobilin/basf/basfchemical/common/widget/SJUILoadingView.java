 ...
 * @author strivecheng
 */
public class SJUILoadingView extends View {
    ...
    public SJUILoadingView(Context context) {
        this(context, null);
    }

    public SJUILoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.SJUILoadingStyle);
    }

    public SJUILoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.SJUILoadingView, defStyleAttr, 0);
        mSize = array.getDimensionPixelSize(R.styleable.SJUILoadingView_sj_ui_loading_view_size, (int) SizeUtils.dp2px( 32));
        mPaintColor = array.getInt(R.styleable.SJUILoadingView_android_color, Color.WHITE);
        array.recycle();
        initPaint();
    }

    public SJUILoadingView(Context context, int size, int color) {
        super(context);
        mSize = size;
        mPaintColor = color;
        initPaint();
